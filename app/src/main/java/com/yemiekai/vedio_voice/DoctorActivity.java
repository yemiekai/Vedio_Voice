 ...
 * https://blog.csdn.net/u013749540/article/details/59113064
 *
...
public class DoctorActivity extends Activity {
    ...
    class MyExpandableAdapter extends BaseExpandableListAdapter{
        ...
        public View getGroupView(int index, boolean arg1, View view,
                                 ViewGroup parent) {
            if(view == null){
                view = getLayoutInflater().inflate(R.layout.doctor_category_first, parent, false);
            }
        ...
        public View getChildView(int index1, int index2, boolean arg2,
            ...
            if(view == null){
                view = getLayoutInflater().inflate(R.layout.doctor_category_second, parent, false);
            }
